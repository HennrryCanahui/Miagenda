...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white dark:bg-blue-900 rounded-3xl shadow-xl shadow-indigo-500/5 dark:shadow-none border border-gray-100 dark:border-blue-800 overflow-hidden">
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nombres" value="{{ old('nombres', $contacto->nombres) }}" placeholder="Ej. Juan Carlos" required class="w-full px-4 py-3 bg-gray-50 dark:bg-blue-900 border border-gray-200 dark:border-blue-800 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="direccion" rows="2" class="w-full px-4 py-3 bg-gray-50 dark:bg-blue-900 border border-gray-200 dark:border-blue-800 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all resize-none">{{ old('direccion', $contacto->direccion) }}</textarea>
                    </div>
