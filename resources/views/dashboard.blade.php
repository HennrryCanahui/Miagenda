...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    <!-- Stat Card 1 -->
    <div class="bg-white/80 backdrop-blur-md dark:bg-blue-900 rounded-2xl shadow-xl shadow-indigo-500/10 dark:shadow-none border border-white/50 dark:border-blue-800 p-6 flex items-center transition-transform hover:-translate-y-1">
    ...
    <!-- Stat Card 2 -->
    <div class="bg-white/80 backdrop-blur-md dark:bg-blue-900 rounded-2xl shadow-xl shadow-blue-500/10 dark:shadow-none border border-white/50 dark:border-blue-800 p-6 flex items-center transition-transform hover:-translate-y-1">
    ...
    <!-- Stat Card 3 -->
    <div class="bg-white/80 backdrop-blur-md dark:bg-blue-900 rounded-2xl shadow-xl shadow-green-500/10 dark:shadow-none border border-white/50 dark:border-blue-800 p-6 flex items-center transition-transform hover:-translate-y-1">
    ...
    <div class="bg-white/80 backdrop-blur-md dark:bg-blue-900 rounded-2xl shadow-xl shadow-purple-500/10 dark:shadow-none border border-white/50 dark:border-blue-800 p-6 flex items-center transition-transform hover:-translate-y-1">
...
<div class="bg-white/80 backdrop-blur-md dark:bg-blue-900 rounded-3xl shadow-xl shadow-indigo-500/10 dark:shadow-none border border-white/50 dark:border-blue-800 overflow-hidden">
    <div class="p-8 border-b border-gray-100 dark:border-blue-800">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-blue-800">
        <a href="{{ route('contacts.create') ?? '#' }}" class="p-8 group hover:bg-white/90 dark:hover:bg-blue-800/50 transition-colors">
        ...
        <a href="{{ route('contacts.index') ?? '#' }}" class="p-8 group hover:bg-white/90 dark:hover:bg-blue-800/50 transition-colors">
            <div class="w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <a href="{{ route('categorias.index') ?? '#' }}" class="p-8 group hover:bg-white/90 dark:hover:bg-blue-800/50 transition-colors">
        ...
        @if(auth()->user()->isAdmin())
        <a href="{{ route('users.index') ?? '#' }}" class="p-8 group hover:bg-white/90 dark:hover:bg-blue-800/50 transition-colors">
