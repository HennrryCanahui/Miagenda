...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    <!-- Stat Card 1 -->
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-indigo-500/5 dark:shadow-none border border-gray-100 dark:border-slate-700 p-6 flex items-center">
    ...
    <!-- Stat Card 2 -->
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-blue-500/5 dark:shadow-none border border-gray-100 dark:border-slate-700 p-6 flex items-center">
    ...
    <!-- Stat Card 3 -->
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-green-500/5 dark:shadow-none border border-gray-100 dark:border-slate-700 p-6 flex items-center">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-purple-500/5 dark:shadow-none border border-gray-100 dark:border-slate-700 p-6 flex items-center">
...
<div class="bg-white dark:bg-slate-800 rounded-3xl shadow-xl shadow-indigo-500/5 dark:shadow-none border border-gray-100 dark:border-slate-700 overflow-hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-slate-700">
        <a href="{{ route('contacts.create') ?? '#' }}" class="p-8 group hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
        ...
        <a href="{{ route('contacts.index') ?? '#' }}" class="p-8 group hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
        ...
        <a href="{{ route('categorias.index') ?? '#' }}" class="p-8 group hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
        ...
        @if(auth()->user()->isAdmin())
        <a href="{{ route('users.index') ?? '#' }}" class="p-8 group hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
